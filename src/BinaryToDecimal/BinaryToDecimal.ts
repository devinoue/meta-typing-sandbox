...
type Extract4Bit<T extends string> =
...
type BinaryNumberTuple = Extract4Bit<'0101'>;
//  ^?

// 基数変換(2進数タプルから10進数リテラル)
type BuildDecimalNumber<B extends Binary[]> = [
  ...BuildTuple<B[3]>,
  ...BuildTuple<B[2] extends 1 ? 2 : B[2] extends 0 ? 0 : never>,
  ...BuildTuple<B[1] extends 1 ? 4 : B[2] extends 0 ? 0 : never>,
  ...BuildTuple<B[0] extends 1 ? 8 : B[2] extends 0 ? 0 : never>,
]['length'];

type DecimalNumber = BuildDecimalNumber<BinaryNumberTuple>;
//  ^?
